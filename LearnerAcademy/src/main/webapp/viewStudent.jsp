...
<div class="form-group">
  ...
  <% 
	...
	while(rs.next()){
		...
		<td><a class="btn btn-success" href="EditStudent.jsp?id=<%=rs.getString("name") %>" role="button">Edit</a></td>
		<td><a class="btn btn-danger" href="removeStudent.jsp?id=<%=rs.getString("name") %>" role="button">Remove</a></td>
		</tr>
	<% }%>	
